        ...
        <article className="mt-6">
          ...
          <ul className="space-y-2.5 mb-4">
            {[
              ...
              ["Hold the payment back.", "Withhold the payment, or at least the GST portion, until the invoice appears in GSTR-2B. It's the strongest card you have."],
          ...
          <ul className="space-y-2.5 mb-4">
            {[
              ...
              "Chase missing invoices with the vendor in writing; withhold the GST portion until it's filed.",
