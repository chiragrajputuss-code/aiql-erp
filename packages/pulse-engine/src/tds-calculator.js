...
const TDS_VENDOR_ANNUAL_THRESHOLD = 100000; // ₹1L
const TDS_VENDOR_SINGLE_THRESHOLD = 30000; // ₹30K per payment
/**
 ...
 */
export function computeTdsAlerts(rows, connectionId, today) {
    if (rows.length === 0)
        return [];
    // Group by vendor
