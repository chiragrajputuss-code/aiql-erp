...
import { patternKeyForScanIssue, patternKeyForRecon, patternKeyForFlux, patternKeyForAgentQuestion, patternKeyForManual, appendHistory, shortHash, } from "../knowledge";
...
describe("appendHistory", () => {
    ...
    function entry(askedAt, verdict = "NORMAL") {
    ...
    it("appends to existing history", () => {
        ...
        const parsed = JSON.parse(round2);
