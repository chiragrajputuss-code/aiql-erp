...
import { scoreDataIntegrity, scorePeriodScope, scoreReconciliation, scoreCompliance, scoreVarianceAnalysis, scoreWorkflowProgress, evaluateHardGates, } from "../readiness-scorer";
...
const issue = (code, severity, affectedRows, exposure = null) => ({ code, severity, affectedRows, exposure });
