...
const DEFAULT_ACCOUNT_RE = /\b(?:(?:AC|GL)-)?(\d{4})(?:[-.](\d{2,3})(?:[-.](\d{2,3}))?)?\b/g;
export function detectAccounts(text, accountPattern) {
 ...
 */
export function maskAccounts(text, map, accountPattern) {
