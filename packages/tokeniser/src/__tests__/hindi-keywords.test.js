...
describe("preprocessHinglish — single keyword replacement", () => {
    ...
    it("replaces 'baaki' with 'outstanding'", () => {
        expect(preprocessHinglish("baaki amount for this month")).toBe("outstanding amount for this month");
    });
...
describe("preprocessHinglish — full Hinglish queries", () => {
    it("preprocesses a typical AP aging query", () => {
        const result = preprocessHinglish("vendor wise baaki amount dikhao jo 5 lakh se upar hai");
    ...
    it("handles mixed English + Hindi query", () => {
        const result = preprocessHinglish("show me sabhi vendors with baaki greater than 10 lakh");
...
describe("preprocessHinglish — credit/debit terms", () => {
    it("replaces 'jama' with 'credit'", () => {
        expect(preprocessHinglish("jama entries for this month")).toBe("credit entries for this month");
    });
