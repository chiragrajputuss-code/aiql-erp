...
// ─── Schema fixtures ──────────────────────────────────────────────────────────
function makeCol(name, dataType = "string") {
...
const NO_TABLE_SCHEMA = { ...FULL_SCHEMA, tables: [] };
// ─── Helper ───────────────────────────────────────────────────────────────────
function sqlOf(question, schema = FULL_SCHEMA) {
    return matchTemplate(question, schema)?.sql ?? "";
}
function idOf(question, schema = FULL_SCHEMA) {
